...
写 AI 战略报告这件事,长期是 BCG / McKinsey / 头部咨询公司的领地——方法论藏在私有项目里,普通从业者无从复用。
...
这个 skill 把笔者做过的几份 AI 战略稿沉淀出来的方法论 + 反模式 + 自检清单,**全部脱敏后开源**。

**目的很简单**:让任何行业的从业者(科技公司 / 医疗 / 教育 / 制造 / 物流 / 零售 / 农业 / 工程基建 / 政府 / ...)都能用 Claude 自己快速过一遍"我们行业的 AI 应用可能性"——不需要请咨询公司,不需要百万预算,一个浏览器 + Claude Code 就能开始。
